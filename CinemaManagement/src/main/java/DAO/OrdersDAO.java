...
public class OrdersDAO {
   ...
   private static OrdersDAO instance;
    ...
    public Boolean Insert(int filmid, int invoiceId, int count) {
        Connection con = DBUtility.openConnection();
        try {
            PreparedStatement pstmt = con.prepareStatement("INSERT INTO `orders`(`film_ID`, `count`, `invoice_ID`) VALUES (?,?,?)");
