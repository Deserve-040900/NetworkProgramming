...
public class CpuGUI extends javax.swing.JInternalFrame {
    ...
    public CpuGUI() {
        try {
            ...
            CpuModify c = (CpuModify)r.lookup("CpuModify");
            initComponents();
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CpuGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, e);
        }
