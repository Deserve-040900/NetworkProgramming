 ...
 * @author Xuan040900
 */
public class RegisterCRUB extends UnicastRemoteObject implements RegisterModify{
    public RegisterCRUB() throws RemoteException{
        ...
        try {
            ...
            if(stm != null){
                try {
                    ...
                    Logger.getLogger(RegisterCRUB.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if(con != null){
                try {
